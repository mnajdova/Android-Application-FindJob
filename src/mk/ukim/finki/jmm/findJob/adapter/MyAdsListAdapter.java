...
import mk.ukim.finki.jmm.findJob.model.NavDrawerItem;
...
public class MyAdsListAdapter extends BaseAdapter {
	...
	public MyAdsListAdapter(Context context, ArrayList<Ad> adsItems){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.my_ads_list_item, null);
        }
         
        
        TextView mtxtAdName = (TextView) convertView.findViewById(R.id.txtAdName);
        TextView mtxtAdDescription = (TextView) convertView.findViewById(R.id.txtAdDescription);
        Button mbtnAdDetails=(Button)convertView.findViewById(R.id.btnViewAdDetails);
        Button mbtnAdSubscribers=(Button)convertView.findViewById(R.id.btnViewAdSubscribers);
        ...
        mbtnAdSubscribers.setOnClickListener(new OnButtonSubscribersClickListener(position, context));
	...
	private class OnButtonSubscribersClickListener  implements OnClickListener{           
        private int mPosition;
        private Context mContext;
         
        OnButtonSubscribersClickListener(int position, Context context){
             mPosition = position;
             mContext=context;
        }
        ...
        public void onClick(View v) {
        	...
        	EmployeerActivity activity=(EmployeerActivity)mContext;
        	activity.displaySubscribedUsersView(EmployeerActivity.SUBSCRIBEDUSERS_POSITION_FRAGMENT, adsItems.get(mPosition));
