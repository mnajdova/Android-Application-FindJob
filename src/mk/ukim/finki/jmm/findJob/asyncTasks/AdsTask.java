...
public class AdsTask extends AsyncTask<String, Void, List<Ad>> {
	...
	public AdsTask(Context context, User user, ArrayList<Ad> adItems, BaseAdapter adsListAdapter, int type) {
	...
	public InputStream getStreamFromUrl(String url) throws Exception {
		...
		HttpPost httppost = new HttpPost(url);
		 ...
		 try {
		        ...
		        nameValuePairs.add(new BasicNameValuePair("user.id", userr.id+""));
